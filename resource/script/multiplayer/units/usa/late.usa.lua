		...
		Units = {
			...
			-- Infantry Squads
				...
				-- All-round Doctrine Squads
					...
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_rifle_late_all_1(usa)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_rifle_late_all_2(usa)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_rifle_late_all_3(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_1st_rifle_late_all_1(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_1st_rifle_late_all_2(usa)"},
				...
				-- Defensive Doctrine Squads
					...
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_rifle_late_def_1(usa)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_rifle_late_def_2(usa)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_rifle_late_def_3(usa)"},

					--{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_eng_late_def_1(usa)"},
					--{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_eng_late_def_2(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_vet_rifle_late_def_1(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_vet_rifle_late_def_2(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_vet_rifle_late_def_3(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_101st_glider_late_def_1(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_101st_glider_late_def_2(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_101st_glider_late_def_3(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_101st_pathfinder_late_def(usa)"},
					...
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_101st_late_def_2(usa)"},
					--]]
				...
				-- Irregular Doctrine Squads
					...
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_rifle_late_irr_1(usa)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_rifle_late_irr_2(usa)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_rifle_late_irr_3(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_82nd_glider_pio_late_irr(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_82nd_glider_late_irr_1(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_82nd_glider_late_irr_2(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_82nd_glider_late_irr_3(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_82nd_recon_late_irr(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_82nd_pathfinder_late_irr(usa)"},
					...
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_82nd_late_irr_2(usa)"},
					--]]
				...
				-- Offensive Doctrine Squads
					...
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_arm_rifle_late_off_3(usa)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_arm_rifle_mech_late_off_1(usa)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_arm_rifle_mech_late_off_2(usa)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_arm_rifle_mech_late_off_3(usa)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_1st_arm_recon_late_off(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_1st_arm_rifle_late_off_1(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_1st_arm_rifle_late_off_2(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_1st_arm_rifle_late_off_3(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_10th_mountain_late_off_1(usa)"},
					{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_10th_mountain_late_off_2(usa)"},
			...
			-- Doctrine Point Units
				...
				--  All-round Doctrine
					...
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier1", "Tank", "Light", "AT",}, unit = "doctrine_m5a1_stuart_late"},
				...
				--  Defensive Doctrine
					---[[
					--{priority = 1.0, type = {"Class3", "Doctrine", "Tier1", "Infantry",}, unit = "doctrine_squad_engineer_late(usa)"},
				...
				--  Irregular Doctrine
					---[[
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier2", "Infantry", "AT",}, unit = "doctrine_squad_m18(usa)"},
					--{priority = 1.0, type = {"Class", "Doctrine", "Tier1", "Plane", "Airstrike",}, unit = "doctrine_p47_250_late"},
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier1", "Cannon", "Support",}, unit = "doctrine_75mm_m1a1_late"},

					{priority = 1.0, type = {"Class3", "Doctrine", "Tier2", "Infantry",}, unit = "doctrine_squad_1st_special_late(usa)"},					
					...
					--{priority = 1.0, type = {"Class3", "Doctrine", "Tier3", "Vehicle", "MG", "Supply", "Ammo",}, unit = "doctrine_cckw_redball_late"},
